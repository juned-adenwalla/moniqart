...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES["file"]["name"] != '') {
        ...
        $img = _getSingleProduct($id, '_img');
    }


    _updateProduct($id, $name, $img, $sku, $price, $discountprice, $productDesc, $isactive, $categoryId, $subcategoryId);
}
                                ...
                                <form method="POST" action="" enctype="multipart/form-data" class="needs-validation"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col" style="margin-bottom: 20px;">
                                            ...
                                            <a href="../uploads/productsPics/<?php echo _getSingleProduct($id, '_img'); ?>"
